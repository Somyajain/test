...
// function makeNewsRequest(currencyName){
//   console.log("called tabledata");
// var url = 'https://newsapi.org/v2/everything?q='+currencyName+'&apiKey=1ef4a184745844a8b3ddaf3a0cf081a7';
//
// var xhr = createCORSRequest('GET',url);
// if (!xhr) {
//   console.log('CORS not supported');
...
//
// // Response handlers.
// // xhr.setRequestHeader("Access-Control-Allow-Origin", "https://newsapi.org/v2/everything?q=bitcoin&apiKey=1ef4a184745844a8b3ddaf3a0cf081a7");
//
// xhr.onload = function() {
//
//   var text = xhr.responseText;
